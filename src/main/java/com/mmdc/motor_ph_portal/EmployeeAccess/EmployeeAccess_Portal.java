...
public class EmployeeAccess_Portal extends javax.swing.JFrame {
    Connection conn = null;
    DatabaseConnect dbConnect = new DatabaseConnect() {};
     
    public EmployeeAccess_Portal() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeAccess_Portal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeAccess_Portal().setVisible(true);
            }
        });
    }
